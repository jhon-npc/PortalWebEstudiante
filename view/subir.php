...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../assets/css/subirpdf.css">
    </head>
    <body>
    <?php 
                        ...
                        <tbody>
                            <?php foreach ($res as $val) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="openModelPDF('<?php echo $val['url'] ?>')" class="btn btn-primary" type="button" style="margin-bottom:10px">Ver Archivo Modal</button>
